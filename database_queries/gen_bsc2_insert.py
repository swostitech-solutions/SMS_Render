...
with open('D:/intern2/database_queries/bsc_2nd_insert.sql', 'w', encoding='utf-8') as f:
    f.write(f'-- BSC 2ND YEAR ({BATCH_CODE}) - {len(df)} STUDENTS\n')
    f.write('BEGIN;\n\n')
...
print(f'✅ INSERT script created: D:/intern2/database_queries/bsc_2nd_insert.sql')
