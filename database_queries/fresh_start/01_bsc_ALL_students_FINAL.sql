...
INSERT INTO "Acadix_studentregistration" (
    ...
    (SELECT id FROM "Acadix_course" WHERE course_code = 'Nursing(BSC)'),
    (SELECT id FROM "Acadix_department" WHERE department_code = 'BSC' AND organization_id = 1),
    (SELECT id FROM "Acadix_academicyear" WHERE academic_year_code = '3rd Year' AND organization_id = 1),
    (SELECT id FROM "Acadix_semester" WHERE semester_code = '5th Semester' AND organization_id = 1),
