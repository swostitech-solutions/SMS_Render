...
with open('D:/intern2/database_queries/bsc_3rd_insert.sql', 'w', encoding='utf-8') as f:
    f.write(f'-- BSC 3RD YEAR ({BATCH_CODE}) - {len(df)} STUDENTS\n')
    f.write('BEGIN;\n\n')
...
print(f'✅ SQL file created: D:/intern2/database_queries/bsc_3rd_insert.sql')
