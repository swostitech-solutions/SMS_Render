...
df = pd.read_excel('D:/intern2/excel files/GNM 2nd YEAR STUDENT DETAILS_2024-2027 updated.xlsx')

# Configuration
BATCH_CODE = '2024-2027'
ACADEMIC_YEAR = '2nd year'
STARTING_ADMISSION_NO = 1029  # After GNM 3rd year (1001-1028)
STARTING_PARENT_ID = 129      # After GNM 3rd year (101-128)

with open('D:/intern2/database_queries/gnm_2nd_insert.sql', 'w', encoding='utf-8') as f:
    f.write('-- GNM 2ND YEAR (2024-2027) - 33 STUDENTS\n')
    f.write('BEGIN;\n\n')
    
    for idx, row in df.iterrows():
        adm_no = STARTING_ADMISSION_NO + idx
...
print(f'SQL file created: D:/intern2/database_queries/gnm_2nd_insert.sql')
print(f'Generated {len(df)} student records')
print(f'Admission: {STARTING_ADMISSION_NO}-{STARTING_ADMISSION_NO+len(df)-1}')
